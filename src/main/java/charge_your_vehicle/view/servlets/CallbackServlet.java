...
import charge_your_vehicle.service.permissions.UserBean;
import charge_your_vehicle.view.commons.AuthenticationControllerProvider;
...
public class CallbackServlet extends HttpServlet {
    ...
    public CallbackServlet(UserBean userBean) {
